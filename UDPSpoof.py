...
#TEST
#print(assembleUDPPacket(b"ping\n", ("127.0.0.1", 33676), ("127.0.0.1", 65535)).hex())
#quit()

#TEST 2
#packet = assemblePacket(b"ping\n", ("127.0.0.1", 51653), ("127.0.0.1", 65535))
#print(packet.hex())
#quit()
...
#sock = createInterfaceSocket(INTERFACE)

#print("Ready")

#data = b"Hello sexy ;)\n"

#packet = _assemblePacket(data, ("8.8.8.8", 45678), ("192.168.0.18", 12345))

#sock[0].sendto(packet, (INTERFACE, ETH_P_IP, 0, 0, bytes([255, 255, 255, 255, 255, 255])))